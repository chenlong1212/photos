...
type Day = {
  ...
  info: string
  count: number
  covers: { previewPath: string; mediaType?: string; durationMs?: number }[]
  coverCount: number
  coverLayout: number
}
    ...
    <div class="timeline-container">
      <template v-for="group in groups" :key="group.year">
        ...
        <div v-for="day in group.days" :key="day.date" class="day-row" :data-date="day.date" @click="openDay(day)">
          ...
          <div class="col-imgs"><div class="cover-frame">
            <div class="cover-box" :class="`cover-grid-${day.coverLayout}`">
              <div v-for="cover in day.covers" :key="cover.previewPath" class="cover-tile"><img :src="mediaUrl(cover.previewPath)" loading="lazy"><span v-if="cover.mediaType==='video'" class="cover-play">▶</span></div>
